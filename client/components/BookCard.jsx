...
<div className = "best-value border best-value col-md-6 text-start ">Horror</div>

</div>
<div className ="row">
<div className ="align-items-center col-md-6 text-end  border"><strong>Pages:</strong></div>
<div className = "best-value border best-value col-md-6 text-start ">397</div>
</div>
<div className ="row align-middle">
<div className ="align-items-center col-md-6 text-end  border"><strong>Year Published:</strong></div>
<div className = "best-value border d-flex align-items-center best-value col-md-6 text-start  border">1977</div>
</div>
...
<div className = "best-value border d-flex align-items-center best-value col-md-6 text-start ">Harry Potter and the Order of the Phoenix</div>
</div>
<div className ="row align-middle">
<div className ="align-items-center col-md-6 text-end border"><strong>Series Name: </strong></div>
<div className = "best-value border d-flex align-items-center best-value col-md-6 text-start ">Harry Potter</div>
</div>
<div className ="row align-middle">
<div className ="align-items-center col-md-6 text-end border"><strong>Place in Series:</strong></div>
<div className = "best-value border d-flex align-items-center best-value col-md-6 text-start ">5</div>
</div>
<div className ="row align-middle">
<div className ="align-items-center col-md-6 text-end border"><strong>Rating:</strong></div>
<div className = "best-value border d-flex align-items-center best-value col-md-6 text-start ">4 stars</div>
</div>
